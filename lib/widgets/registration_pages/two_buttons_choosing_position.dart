    ...
    return  Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            RoundedStretchButton(color: Colors.green[600], text:  "I am a Nutritionist", function: () => { }),
           const SizedBox(height: 20),
            RoundedBorderStretchButton(text: "I am Searching for Doctor", function: () {Navigator.pushNamed(context, RouteGenerator.sign_in);},),
          ],
        ),
      ),
    );
